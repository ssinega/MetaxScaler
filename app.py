...
def dataset_info() -> dict:
    ...
    return {
        ...
        "categories": dict(Counter(t["category"] for t in TICKETS)),
        "priorities": dict(Counter(t["priority"] for t in TICKETS)),
        "actions": dict(Counter(t["action"] for t in TICKETS)),
    }
